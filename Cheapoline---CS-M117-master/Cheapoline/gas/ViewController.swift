...
class ViewController: UIViewController, CLLocationManagerDelegate {
    ...
    var station1 = station(name: "", distance: "", price: "")
    var station2 = station(name: "", distance: "", price: "")
    var station3 = station(name: "", distance: "", price: "")
    ...
    @IBAction func find(_ sender: Any) {
        ...
        /*print(station1.name, station1.distance, station1.price)
        print(station2.name, station2.distance, station2.price)
        print(station3.name, station3.distance, station3.price)*/
    }
